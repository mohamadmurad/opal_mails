...
Route::post('/receipt/delete',[\App\Http\Controllers\api\ApiReceiptsController::class,'destroy'])->middleware('auth:api');
Route::post('/receipt/edit',[\App\Http\Controllers\api\ApiReceiptsController::class,'update'])->middleware('auth:api');
